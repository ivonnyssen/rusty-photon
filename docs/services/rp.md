...
| `get_site` | — | latitude_degrees, longitude_degrees | The configured observer site (mount-validated on connect); lets a plugin source coordinates instead of duplicating them |
