...
| [predictive-deadlines-and-watchdog.md](plans/predictive-deadlines-and-watchdog.md) | Predictive operation deadlines in `rp` + Sentinel operation watchdog (5 phases). **Done:** Phase 1 event surface (#346), Phase 2 §2.1 slew (#348), §2.2/§2.3 park+focuser (#352). **Open:** Phase 2 §2.4 exposure + §2.5 centering, Phase 3 SSE endpoint, Phase 4 Sentinel watchdog, Phase 5 corrective-action ladder. Active sub-plan: [phase-3 SSE endpoint](plans/predictive-deadlines-phase3-sse.md). Archived sub-plans: [phase-1 event surface](plans/archive/predictive-deadlines-phase1-event-surface.md), [phase-2 §2.1 slew](plans/archive/predictive-deadlines-phase2-slew.md), [phase-2 §2.2/§2.3 park+focuser](plans/archive/predictive-deadlines-phase2-park-focuser.md) |
