...
|------|---------|--------|----------|--------|----------|--------|--------|
| 2026-08-07 | zwo-camera | ZWO ASI1600MM-Cool + ASI178MM + ASI120MC-S | Fedora Linux 44 x86_64 | [`28bdd094`](https://github.com/rusty-photon/rusty-photon/commit/28bdd094) (`main` + the `rusty-photon-camera-core` refactor under test) | 4.4.0 | `alpacaprotocol` + `conformance` clean on **all three** bodies from one service instance; puts the shared ROI rules, Bayer offsets and `ImageArray` unpack on real hardware | [record](2026-08-07-zwo-camera-three-cameras-linux/README.md) |
