...
The previous `test-conformance.sh` approach is being replaced by this integrated approach:

**Old approach:**
- Manual shell script execution
- External ConformU management
- Manual result parsing

**New approach:**
- Integrated with `cargo test`
- Programmatic ConformU execution via ascom-alpaca crate
