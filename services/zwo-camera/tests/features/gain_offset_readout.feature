...
Feature: Gain, offset, and readout modes
  ...
  (GO3). ReadoutModes is the driver's named speed and bit-depth list; setting
  a mode validates the index, updates cached state, and rejects an unknown
  index with INVALID_VALUE (RM1).
