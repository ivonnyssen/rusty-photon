//! BDD entry point. Spawns the zwo-focuser binary (built with the `simulation`
...
bdd_infra::bdd_main! {
    ...
    use world::FocuserWorld;

    FocuserWorld::cucumber()
        ...
        // Skip `@wip` scenarios so an in-flight area can ride the branch
