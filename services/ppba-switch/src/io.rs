...
/// for tests that don't require actual serial I/O.
#[async_trait]
...
///
/// This trait abstracts the writing functionality, enabling mocking
/// for tests that don't require actual serial I/O.
#[async_trait]
#[cfg_attr(test, mockall::automock)]
...
///
/// This trait abstracts serial port creation, enabling mocking
/// for tests that don't require actual hardware.
#[async_trait]
#[cfg_attr(test, mockall::automock)]
...
mod tests {
    ...
    fn test_serial_pair_creation() {
        // Just verify the struct can be created with mock implementations
