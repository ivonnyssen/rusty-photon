...
/// Standard connection responses: ping + status + power stats + polling extras.
/// Auto-dew is OFF (0) in these responses.
...
/// Connection responses with auto-dew ENABLED (1).
pub fn autodew_enabled_responses() -> Vec<String> {
    vec![
        "PPBA_OK".to_string(),
